...
set "JAVA_OPTS=-Xms512M -Xmx2048M -XX:MetaspaceSize=96M -XX:MaxMetaspaceSize=512m"
rem # set "JAVA_OPTS=-Xms8192M -Xmx10240M -XX:MetaspaceSize=96M -XX:MaxMetaspaceSize=1024m"
rem # set "JAVA_OPTS=%JAVA_OPTS% -XX:+UseG1GC -XX:MaxGCPauseMillis=1000 -XX:+PrintGCDetails -Xloggc:/Wildfly/standalone/log/gc.log -XX:+PrintGCDateStamps -XX:+UseGCLogFileRotation -XX:NumberOfGCLogFiles=5 -XX:GCLogFileSize=100M"
...
set "JAVA_OPTS=%JAVA_OPTS% -Djboss.server.default.config=hcmb-wf11-standalone.xml"
